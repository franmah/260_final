...
router.post('/login', async (req, res) => {
  console.log("trying to log user: " + req.body.username);
  // Make sure that the form coming from the browser includes a username and a
...
// get logged in user
// Notice the call to validUser after the path and before the callback
...
// logout
// note the use of validUser to make sure the user is logged in
